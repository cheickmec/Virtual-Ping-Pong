...
static const char qt_meta_stringdata_GameView[] = {
    "GameView\0\0,\0movePaddle(char,int)\0"
};
...
void GameView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->movePaddle((*reinterpret_cast< const char(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void GameView::movePaddle(const char _t1, int _t2)
{
